...
var containsStraight = function (hand) {                              // !!! awesomeness
...
var containsFullHouse = function (hand) {
  ...
  // why not just use var values = Object.values(counts) ?
...
var containsFourOfAKind = function (hand) {
    ...
    return Object.keys(counts).filter(function (rank) {
        return counts[rank] >= 4;                             // >= should be ===, since there is no more than 4 ranks
    }).length >= 1;
};
